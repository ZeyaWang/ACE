...
tasks = ['sim_convex_dense_1.0','sim_convex_dense_2.0','sim_convex_sparse_1.0', 'sim_convex_sparse_2.0']
tasksv = {'sim_convex_dense_1.0': r'Simulation 2 ($\sigma = 1$)','sim_convex_dense_2.0': 'Simulation 2 ($\sigma = 2$)',
          'sim_convex_sparse_1.0': r'Simulation 1 ($\sigma = 1$)', 'sim_convex_sparse_2.0': r'Simulation 1 ($\sigma = 2$)'}
