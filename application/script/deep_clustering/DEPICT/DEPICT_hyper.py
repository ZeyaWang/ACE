...
#parser.add_argument('--num_clusters', default=10)
...
##############################  Build DEPICT Model  ##############################
encoder, decoder, loss_recons, loss_recons_clean, ec1, ec2 = build_depict(input_var, n_in=dimensions,
...
############################## Train DEPICT Model  ##############################
train_depict(dataset, X, y, input_var, decoder, encoder, ec1, ec2, loss_recons, num_clusters, y_pred, output_path,
